...
def suggest_rendered_plan_furniture(
    ...
    return [
        place("floor_patch_marble", 0.48, 0.55, 6.1, 5.5, 0),
        place("floor_patch_balcony", 0.50, 0.08, 4.6, 0.75, 0),
        place("floor_patch_balcony", 0.47, 0.88, 5.3, 0.8, 0),
        place("floor_patch_kitchen", 0.88, 0.70, 2.3, 2.8, 0),
        place("floor_patch_bath", 0.83, 0.42, 1.8, 1.2, 0),
        place("floor_patch_bath", 0.24, 0.13, 1.0, 1.4, 0),
        place("floor_patch_lift", 0.15, 0.70, 1.3, 1.3, 0),
        place("stair_step", 0.15, 0.17, 1.8, 0.12, 0),
        place("stair_step", 0.15, 0.20, 1.8, 0.12, 0),
        place("stair_step", 0.15, 0.23, 1.8, 0.12, 0),
        place("stair_step", 0.15, 0.26, 1.8, 0.12, 0),
        place("stair_step", 0.15, 0.29, 1.8, 0.12, 0),
        place("stair_step", 0.15, 0.32, 1.8, 0.12, 0),
        place("stair_step", 0.15, 0.35, 1.8, 0.12, 0),
        place("stair_step", 0.15, 0.38, 1.8, 0.12, 0),
        place("railing", 0.50, 0.05, 4.8, 0.08, 0),
        place("railing", 0.48, 0.91, 5.6, 0.08, 0),
        place("railing_post", 0.28, 0.05, 0.08, 0.08, 0),
        place("railing_post", 0.36, 0.05, 0.08, 0.08, 0),
        place("railing_post", 0.44, 0.05, 0.08, 0.08, 0),
        place("railing_post", 0.52, 0.05, 0.08, 0.08, 0),
        place("railing_post", 0.60, 0.05, 0.08, 0.08, 0),
        place("railing_post", 0.68, 0.05, 0.08, 0.08, 0),
        place("railing_post", 0.28, 0.91, 0.08, 0.08, 0),
        place("railing_post", 0.38, 0.91, 0.08, 0.08, 0),
        place("railing_post", 0.48, 0.91, 0.08, 0.08, 0),
        place("railing_post", 0.58, 0.91, 0.08, 0.08, 0),
        place("railing_post", 0.68, 0.91, 0.08, 0.08, 0),
        place("bed", 0.32, 0.34, 1.8, 2.2, 0),
        place("bed", 0.79, 0.22, 1.8, 2.1, 0),
        place("wardrobe", 0.44, 0.35, 0.45, 1.6, 0),
        place("wardrobe", 0.69, 0.26, 0.45, 1.5, 0),
        ...
        place("lamp", 0.22, 0.31, 0.28, 0.28),
        place("lamp", 0.43, 0.31, 0.28, 0.28),
        place("lamp", 0.70, 0.22, 0.28, 0.28),
        place("lamp", 0.88, 0.22, 0.28, 0.28),
        ...
        place("tv_unit", 0.24, 0.72, 0.25, 1.7, 90),
        place("lamp", 0.20, 0.79, 0.28, 0.28),
        place("lamp", 0.60, 0.79, 0.28, 0.28),
        ...
        place("stove", 0.83, 0.66, 0.55, 0.55, 0),
        place("sink", 0.91, 0.69, 0.5, 0.65, 0),
        place("appliance", 0.92, 0.55, 0.65, 0.9, 0),
        place("dining_table", 0.78, 0.67, 0.8, 1.2, 0),
        place("toilet", 0.84, 0.41, 0.7, 1.1, 0),
        place("sink", 0.78, 0.41, 0.45, 0.45, 0),
        place("toilet", 0.23, 0.14, 0.6, 1.0, 0),
        place("sink", 0.24, 0.09, 0.4, 0.4, 0),
        place("door", 0.47, 0.31, 0.08, 0.9, 0),
        place("door", 0.68, 0.33, 0.08, 0.9, 0),
        place("door", 0.74, 0.50, 0.08, 0.9, 0),
        place("door", 0.27, 0.44, 0.08, 0.9, 90),
        place("window", 0.37, 0.89, 1.5, 0.08, 0),
        place("window", 0.55, 0.89, 1.5, 0.08, 0),
        place("window", 0.82, 0.11, 1.1, 0.08, 0),
        place("window", 0.92, 0.78, 1.3, 0.08, 0),
        place("plant", 0.68, 0.08, 0.55, 0.55),
        place("plant", 0.27, 0.05, 0.5, 0.5),
        place("plant", 0.62, 0.05, 0.5, 0.5),
